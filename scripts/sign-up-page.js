let loginPassWordShow = document.getElementById("lpassword");
let eyeSlash = document.getElementById("login-password-eye");
let signUpPassword = document.getElementById("signUp-password-eye");
...
function showPassword() {
  ...
  if (loginPassWordShow.type === "text") {
...
function showPasswordSignUp() {
  signUpPassword.classList.toggle("fa-eye-slash");
  if (spassword.type === "text") {
